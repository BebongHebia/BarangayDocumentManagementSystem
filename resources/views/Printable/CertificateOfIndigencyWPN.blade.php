...
<head>
    ...
    <style>
        #mainPage {
            ...
            height: 1240px;
            margin: auto;
            background-image: url('{{ asset("assets/images/CertificateOfIndigency.jpeg") }}');
        ...
        <div class="row">
            <div class="col-sm-12">
                <div id="mainPage">
                    ...
                    <p class="text-justify" style="position: relative; left: 320px; bottom:50px; width:55%; text-align: justify;">
                        <b>TO WHOM IT MAY CONCERN:</b><br>
THIS IS TO CERTIFY that <b>{{ $transaction->user->completeName }}</b> is a bona fide resident at <b>{{ $transaction->bar_indigent_details->sector }}</b> Barangay 08, Malaybalay City.
<br><br>
That the subject is <b>categorized as an indigent</b> member of the community and she/he is the <b>{{ $transaction->bar_indigent_details->relation }}</b> of <b>{{ $transaction->bar_indigent_details->authorized }}</b> (patient) having a monthly income that is insufficient to meet the basic needs of their family.
<br><br>This certification is issued upon the request of <b>{{ $transaction->user->completeName }}</b>
<br><br>THIS DOCUMENT SHALL SERVE AS A SUPPORTING REQUIREMENT FOR <b>{{ $transaction->bar_indigent_details->purpose }}</b> purposes.</b>
