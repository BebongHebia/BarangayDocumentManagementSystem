        ...
        <div class="row">
            <div class="col-sm-12">
                <div id="mainPage">
                    ...
                    <p class="text-justify" style="position: relative; left: 320px; bottom:2px; width:55%; text-align: justify">
...
<br><br>
That the subject is <b>categorized as an indigent</b> member of the community and having a monthly income that is insufficient to meet the basic needs of their family. 
<br><br>This certification is issued upon the request of the above-named person for <b>{{ $transaction->bar_indigent_details->purpose }}</b> purposes.
