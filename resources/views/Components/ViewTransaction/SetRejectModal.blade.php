    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h4 class="modal-title">Set Reject Requested Document</h4>
            ...
            <div class="modal-body">
                ...
                <form id="setRejectTransactionForm">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label>Remarks/Reasons of Rejection</label>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-danger" onclick="setRejectTransaction(event)">
                    <i class="fas fa-save"></i> Set Reject
                </button>
            </div>
        </div>
        <!-- /.modal-content -->
